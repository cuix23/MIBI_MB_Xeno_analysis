...
MB_Xeno_c1m1_require <- MB_Xeno_c1m1[, 21:55]
...
```{r}
save(spe, file = ("/Users/cuixinyue/Desktop/MB_Xeno_analysis/Output/RData/02_SPE/02_MB_Xeno_spe.rds"))
```
